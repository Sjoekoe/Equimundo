                    ...
                    <tr>
                        ...
                        <td>
                            <table cellspacing="0" cellpadding="0" width="100%" style="border-collapse:collapse">
                                ...
                                <tr>
                                    <td>
                                        <span style="font-family:Helvetica Neue,Helvetica,Lucida Grande,tahoma,verdana,arial,sans-serif;font-size:16px;line-height:21px;color:#141823">Hi {{ $userName }},</span>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td>
                                        <span style="font-family:Helvetica Neue,Helvetica,Lucida Grande,tahoma,verdana,arial,sans-serif;font-size:16px;line-height:21px;color:#141823">We noticed you haven't activated your account yet. Please activate it in order to further enjoy Equimundo</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td height="14" style="line-height:14px">&nbsp;</td>
                                                        ...
                                                        <a href="{{ $activationLink }}"
                                                           ...
                                                           target="_blank">
                                                            <center><font size="3"><span
                                                                            style="font-family:Helvetica Neue,Helvetica,Lucida Grande,tahoma,verdana,arial,sans-serif;white-space:nowrap;font-weight:bold;vertical-align:middle;color:#ffffff;font-size:14px;line-height:14px">Activate&nbsp;Your&nbsp;Account</span></font>
                                                            </center>
                                                        </a></td>
                                                </tr>
                                                </tbody>
                            ...
                            <table cellspacing="0" cellpadding="0" width="100%" style="border-collapse:collapse">
                                ...
                                <tr>
                                    <td style="font-family:Helvetica Neue,Helvetica,Lucida Grande,tahoma,verdana,arial,sans-serif;font-size:11px;color:#aaaaaa;line-height:16px">
                                        This message was sent to <a href="mailto:{{ $userMail }}" style="color:#1ABC9C;text-decoration:none" target="_blank">{{ $userMail }}</a>.
                                        If this is some kind of mistake, please let us know.
                                    </td>
                                </tr>
                                </tbody>
                            </table>
