                    ...
                    <tr>
                        ...
                        <td>
                            <table cellspacing="0" cellpadding="0" width="100%" style="border-collapse:collapse">
                                ...
                                <tr>
                                    <td>
                                        <span style="font-family:Helvetica Neue,Helvetica,Lucida Grande,tahoma,verdana,arial,sans-serif;font-size:16px;line-height:21px;color:#141823">Hi,</span>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td>
                                        <span style="font-family:Helvetica Neue,Helvetica,Lucida Grande,tahoma,verdana,arial,sans-serif;font-size:16px;line-height:21px;color:#141823">{{ $userName }} has invited you to join Equimundo. You can register by clicking the following button.</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td height="14" style="line-height:14px">&nbsp;</td>
                                                        ...
                                                        <a href="{{ $activationLink }}"
                                                           ...
                                                           target="_blank">
                                                            <center><font size="3"><span
                                                                            style="font-family:Helvetica Neue,Helvetica,Lucida Grande,tahoma,verdana,arial,sans-serif;white-space:nowrap;font-weight:bold;vertical-align:middle;color:#ffffff;font-size:14px;line-height:14px">Register&nbsp;Here</span></font>
                                                            </center>
                                                        </a></td>
                                                </tr>
                                                </tbody>
