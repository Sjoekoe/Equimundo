                    ...
                    <tr>
                        ...
                        <td>
                            <table cellspacing="0" cellpadding="0" width="100%" style="border-collapse:collapse">
                                ...
                                <tr>
                                    <td>
                                        <span style="font-family:Helvetica Neue,Helvetica,Lucida Grande,tahoma,verdana,arial,sans-serif;font-size:16px;line-height:21px;color:#141823">{{ $sender['first_name'] . ' ' . $sender['last_name'] }} has added {{ $family['name'] }} in the pedigree for {{ $horse['name'] }}</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td height="14" style="line-height:14px">&nbsp;</td>
                                                        ...
                                                        <a href="{{ $link }}"
                                                           ...
                                                           target="_blank">
                                                            <center><font size="3"><span
                                                                            style="font-family:Helvetica Neue,Helvetica,Lucida Grande,tahoma,verdana,arial,sans-serif;white-space:nowrap;font-weight:bold;vertical-align:middle;color:#ffffff;font-size:14px;line-height:14px">Check&nbsp;it&nbsp;Out</span></font>
                                                            </center>
                                                        </a></td>
                                                </tr>
                                                </tbody>
