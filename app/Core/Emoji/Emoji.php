...
namespace EQM\Core\Emoji;

use EQM\Core\Emoji\Exceptions\UnknownCharacter;
...
class Emoji
{
     ...
     * @return string mixed
     * @throws \EQM\Core\Emoji\Exceptions\UnknownCharacter
     */
    public static function getCharacter($characterName)
    {
     ...
     * @throws \EQM\Core\Emoji\Exceptions\UnknownCharacter
     */
    public static function __callStatic($methodName, array $paramters)
    {
     ...
     * @return string
     */
    protected static function convertCharacterNameToConstantName($characterName)
    {
