...
get('horses/{horse_slug}/palmares', ['as' => 'palmares.index', 'uses' => 'PalmaresController@index', 'middleware' => 'auth']);
...
post('palmares/{palmares}/edit', ['as' => 'palmares.update', 'uses' => 'PalmaresController@update', 'middleware' => 'auth']);
