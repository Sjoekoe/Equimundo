...
Route::post('statuses/create', ['as' => 'statuses.store', 'uses' => 'StatusController@store', 'middleware' => 'auth']);
...
Route::put('status/{status}/edit', ['as' => 'statuses.update', 'uses' => 'StatusController@update', 'middleware' => 'auth']);
